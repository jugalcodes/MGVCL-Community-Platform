...
// ======================================== HANDLING IMAGE UPLOAD ====================================
    ...
    const handleUploadImage = async () => {
        try {
            ...
            setImageUploadError(null); // we used here if there is any error then it will remove the error and proceed further
        ...
        <div className='p-3 max-w-3xl mx-auto min-h-screen'>
            ...
            <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
                <div className='flex flex-col gap-4 sm:flex-row justify-between'>
                    <TextInput type='text' id='title' placeholder='Title' required className='flex-1' onChange={(e) => setFormData({ ...formData, title: e.target.value})}></TextInput>
                    <Select
                ...
                {/* // ======================================== REACT QUILL SPACE FOR MAIN CONTENT  =================================== */}
