...
export default function CommentSection({ postId }) {
  ...
  {/* ============================ FETCHES THE ALL COMMENTS OF THE RESPECTIVE POST ============================= */}
  useEffect(() => {
...
{/* ============================ HANDLES LIKE FUNCTIONALITY ============================= */}
  ...
  {/* ============================ HANDLES EDITTING FUNCTIONALITY ============================= */}
  const handleEdit = async (comment, edittedContent) => {
    setComments(
      comments.map((c) => c._id === comment._id ? {
        ...c, content: edittedContent
      } : c
      )
    );
  }
      ...
      {currentUser ?
        (
          <div className='flex items-center gap-1 my-5 text-gray-500'>
            ...
            <img className='h-7 w-7 object-cover rounded-md ' src={currentUser.profilePicture}></img>
...
{/* ============================ MODAL FOR SUPPORTING DELETE FUNCTIONALITY ============================= */}
